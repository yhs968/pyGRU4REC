...
class GRU4REC:
    ...
    def run_epoch(self):
        ...
        for input, target, hidden in G.generate_batch(df=self.df_train, batch_size=self.batch_size, hidden=hidden,
                                                      training=True,
    ...
    def init_data(self, df_train, df_test, session_key, time_key, item_key):
        ...
        self.df_test = self.init_df(df_test, session_key, time_key, item_key, iids=self.df_train['iid'].unique())
